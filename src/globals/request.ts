...
declare global {
    const getProcessedApiRequestQueries: (
        ctx: Context,
...
setReadonlyConstantToGlobalThis<typeof getProcessedApiRequestQueries>(
    'getProcessedApiRequestQueries',
    (ctx, filterInFields, processObjectIdIgnoreFields) => {

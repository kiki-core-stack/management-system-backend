...
declare global {
    ...
    const numberEnumToZodOpenAPISchema: (enumObject: EnumLike, enumName: string, toTextMap?: Record<number | string, string>) => ZodNativeEnum<EnumLike>;
}
...
setReadonlyConstantToGlobalThis<typeof numberEnumToZodOpenAPISchema>('numberEnumToZodOpenAPISchema', (enumObject, enumName, toTextMap) => {
